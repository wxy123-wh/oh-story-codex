...
长篇 = 一个个叙事单元连接，连接物 = 钩子。每个单元结束前必须留下未处理干净的东西。钩子有"定向"作用。
...
- **禁情绪母题扎堆**。比「每章自闭合」更隐蔽的疲劳源，是连续多章同一情绪母题高位运行（如连五章家国 / 泪目）——章节定位分得再开也救不了。排卷纲情绪弧线时逐行看相邻 3-4 章的情绪基调，同母题别连超 2-3 章；靠换情绪、换钩子方式、多线穿插来差异化，不是靠砍钩子。
